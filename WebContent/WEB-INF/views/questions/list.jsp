	...
	<div class="container">
		...
		<div class="form-group">
			...
			<c:if
				...
				<form style="margin-bottom: 20px;" class="form-inline pull-right"
					action="questions.html" method="get">
					<div class="form-group">
						<label>Catégorie : </label> <select class="form-control"
							name="categorie" onchange="submit()">
			...
			<form style="margin-bottom: 20px; margin-right: 50px;"
				class="form-inline pull-right" action="questions.html" method="get">
				<div class="form-group">
					<label>Matières : </label> <select class="form-control"
						name="matiere" onchange="submit()">
						<option id="0" value="0">Toutes</option>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="questions.html" method="post">
							<label>Libellé de la question : </label> <input
